...
(function() {
  ...
  goog.require('gn_search_inline_config');
  goog.require('gn_search_inline_directive');

  var module = angular.module('gn_search_inline',
      ['gn_search', 'gn_search_inline_config',
       'gn_search_inline_directive', 'gn_related_directive',
