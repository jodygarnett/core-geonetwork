...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Règles de
    validation pour le standard ISO 19115-1:2014
  </svrl:text>
...
<xsl:template match="/mdb:MD_Metadata/mdb:metadataScope/                           mdb:MD_MetadataScope[not(mdb:resourceScope/                             mcc:MD_ScopeCode/@codeListValue = 'dataset')]"
      ...
      <xsl:variable name="scopeCode" select="mdb:resourceScope/mcc:MD_ScopeCode/@codeListValue"/>
      ...
      <xsl:variable name="nilReason" select="mdb:name/@gco:nilReason"/>
