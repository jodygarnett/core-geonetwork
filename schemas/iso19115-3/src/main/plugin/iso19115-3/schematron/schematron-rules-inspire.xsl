...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:value-of select="$fileDirParameter"/>
         ...
         <svrl:ns-prefix-in-attribute-values uri="http://standards.iso.org/iso/19115/-3/msr/1.0" prefix="msr"/>
...
<xsl:template match="//mri:MD_DataIdentification|    //*[@gco:isoType='mri:MD_DataIdentification']"
      ...
      <xsl:variable name="inspire-thesaurus"
                    select="document(concat($thesaurusDir, '/external/thesauri/theme/inspire-theme.rdf'))"/>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:diagnostic-reference ref="#_{geonet:element/@ref}"
                  ...
                  <xsl:attribute name="xml:lang">en</xsl:attribute>
INSPIRE Theme thesaurus not found. Check installation in codelist/external/thesauri/theme. Download thesaurus from https://geonetwork.svn.sourceforge.net/svnroot/geonetwork/utilities/gemet/thesauri/.</svrl:diagnostic-reference> 
               <svrl:diagnostic-reference ref="#_{geonet:element/@ref}"
                                          diagnostic="rule.keyword-thesaurus-file-failure-fr">
                  <xsl:attribute name="xml:lang">fr</xsl:attribute>
Le thesaurus du thème ISNPIRE n'a pas été trouvé. Vérifier si ce dernier est bien installer (codelist/external/thesauri/theme). Télécharger le thesaurus à partir de l'url suivant https://geonetwork.svn.sourceforge.net/svnroot/geonetwork/utilities/gemet/thesauri/.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
